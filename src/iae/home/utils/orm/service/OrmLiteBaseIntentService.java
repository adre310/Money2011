package iae.home.utils.orm.service;
...
public abstract class OrmLiteBaseIntentService<H extends OrmLiteSqliteOpenHelper> extends IntentService {
	...
	protected class DisplayToast implements Runnable{ 
		  ...
		  public void run(){ 
		     Toast.makeText(m_context, m_text, Toast.LENGTH_SHORT).show(); 
		  } 
		} 
	...
	protected void showToast(String text) {
		m_handler.post(new DisplayToast(this, text));
	}
